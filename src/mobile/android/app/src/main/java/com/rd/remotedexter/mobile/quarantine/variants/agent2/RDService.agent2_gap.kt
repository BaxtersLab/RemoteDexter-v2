...
class RDService : Service() {
    ...
    private lateinit var transferManager: com.rd.remotedexter.mobile.transfer.TransferManager
    ...
    override fun onCreate() {
        ...
        transferManager = com.rd.remotedexter.mobile.transfer.TransferManager(
            context = this,
            sendCommand = { command ->
                // In a real implementation, this would send to the desktop via transport layer
                Log.d(TAG, "Sending command: ${command.type}")
                com.rd.remotedexter.mobile.protocol.CommandResponse(true, "Command sent")
            },
