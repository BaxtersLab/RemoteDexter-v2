...
// EncodeCommandRequest encodes CommandRequest
...
func DecodeCommandRequest(data []byte) (CommandRequest, error) {
	...
	if len(data) < 1+typeLen+1 {
		return CommandRequest{}, errors.New("invalid data")
	}
...
// EncodeCommandResponse encodes CommandResponse
...
func DecodeCommandResponse(data []byte) (CommandResponse, error) {
	...
	if len(data) < 1+statusLen+1 {
		return CommandResponse{}, errors.New("invalid data")
	}
