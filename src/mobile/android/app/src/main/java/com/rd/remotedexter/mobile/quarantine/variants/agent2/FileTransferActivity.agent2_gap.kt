...
import com.rd.remotedexter.mobile.transfer.TransferManager
        ...
        cancelButton = Button(this).apply {
            ...
            setOnClickListener {
                ...
                transferManager.getActiveTransfers().forEach { transfer ->
                    when (transfer) {
                        is com.rd.remotedexter.mobile.transfer.FileSender.FileTransfer -> {
                            transferManager.cancelTransfer(transfer.fileId)
                        }
                        is com.rd.remotedexter.mobile.transfer.FileReceiver.FileTransfer -> {
                            transferManager.cancelTransfer(transfer.fileId)
                        }
                    }
                }
